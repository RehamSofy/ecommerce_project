...
<!-- Custom Theme files --> <!--theme-style-->
        ...
        <ul class="nav navbar-nav nav_1">
			...
			<div id="small-dialog" class="mfp-hide">
				<div class="search-top">
					<div class="login-search">	    
						...
						<input type="submit" value="" > <!-- button searching -->
						<input type="text" id="search"  name="searching" onkeypress="keyListener()" value="Search.." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search..';}">		
					    </form>
					</div>
					<p>Shopin</p>
				</div>				
			...
			<script>
               function keyListener() {
            	   ...
            	   var srchdata = document.getElementById('search').value; 
                    
                   if(srchdata == ""){}
                   else{
                      // document.location.href="Yui";    
                   }  
